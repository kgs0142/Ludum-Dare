package com.scene 
{
    ...
    import com.scene.struct.CCircleData;
    import com.scene.struct.CFlxTileMapExt;
    import com.scene.struct.CShapeData;
    import com.scene.struct.CTextData;
    import com.scene.struct.FlxGroupLayer;
    ...
    public class CSceneManager extends CBaseScene
    {
                                      ...
                                      vLayerProperties:Vector.<Object>):void 
        {
            for each(var xmlMap:XML in xmlMapList)
            {
                ...
                var sCsvName:String = GET_NAME_NO_EXT(xmlMap.@csv);
                var sTextureName:String = GET_NAME_NO_EXT(xmlMap.@tiles);
