package game.scene 
{
    ...
    public class CSceneManager extends CBaseScene
    {
        ...
        private var m_gTriggerLayer:FlxGroupLayer;
        
        private var m_gCollideLayer:FlxGroup;
        private var m_gOverlapLayer:FlxGroup;
        ...
        public function CreateScene(sSceneXmlName:String, fnCreateLevelComplete:Function) : void
        {
            ...
            m_gCollideLayer = new FlxGroup()
            m_gOverlapLayer = new FlxGroup();
            
            this.add(m_gOverlapLayer);
            this.add(m_gCollideLayer);
			...
			for each(var xmlLayer:XML in xml.layer)
			{
                ...
                else if (xmlLayer.@name == "triggers")
                {
                    m_gTriggerLayer = gLayer;
                    m_gOverlapLayer.add(gLayer);
                }
                else
                {
                    m_gCollideLayer.add(gLayer);
        ...
        protected function ProcessSprite(xmlSpriteList:XMLList, gLayer:FlxGroupLayer) : void 
        {
            for each(var xmlSprite:XML in xmlSpriteList)
            {
                ...
                var sClzName:String = xmlSprite.attribute("class");
                var clz:Class = getDefinitionByName(sClzName) as Class;
                                                          ...
                                                          vProperties:Vector.<Object>):Object
		{
			...
			{
				 //Create the CTrigger.
				var bData:CBoxData = obj as CBoxData;
				var trigger:Trigger = new Trigger(bData.x, bData.y, bData.width, bData.height);
                
				trigger.ParseProperties(vProperties);
				
                trigger.scrollFactor.x = nScrollX;
                trigger.scrollFactor.y = nScrollY;
                
                //level.addSpriteToLayer(trigger, FlxSprite, gLayer, trigger.x, 
                                       //trigger.y, bData.angle, nScrollX, nScrollY);
        ...
        public override function Initial() : void   
        {
            ...
            m_gOthersLayer = null;
            m_gTriggerLayer = null;
            
            m_gCollideLayer = null;
            m_gOverlapLayer = null;
        ...
        public function get pBoundsMin():Point 
        {
            return m_pBoundsMin;
        }
        
        public function get pBoundsMax():Point 
        {
            return m_pBoundsMax;
        }
        
        public function get gCollideLayer():FlxGroup 
        {
            return m_gCollideLayer;
        }
        
        public function get gOverlapLayer():FlxGroup 
        {
            return m_gOverlapLayer;
        }
    }
}
