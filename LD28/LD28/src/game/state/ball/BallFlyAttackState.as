package game.state.ball 
{
	...
	/**
     * 球飛行攻擊中的State，幫它加特效看起來像有攻擊力
     * @author Husky
     */
    public class BallFlyAttackState extends BaseBallState 
    {
        ...
        public function BallFlyAttackState(instance:Ball) 
        {
            super(instance);
        }
