package org.flixel
{
	...
	public class FlxGame extends Sprite
	{
		 ...
		 */
		protected function onMouseLeftDown(FlashEvent:MouseEvent):void
		{
			if(_debuggerUp)
			{
			...
			FlxG.mouse.handleMouseLeftDown(FlashEvent);
		}
		...
		protected function create(FlashEvent:Event):void
		{
			...
			stage.addEventListener(MouseEvent.MOUSE_DOWN, onMouseLeftDown);
			stage.addEventListener(MouseEvent.MOUSE_UP, onMouseLeftUp);
