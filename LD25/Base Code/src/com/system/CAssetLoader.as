package system
{
    ...
    public class CAssetLoader extends EventDispatcher
    {
        ...
        public function loadAsset(fnComplete:Function) : void
        {
            ...
            this.LoadLua(CAssetDefine.GAME_PLAY_LUA_NAME, CAssetDefine.GAME_PLAY_LUA_PATH);
            this.LoadLua(CAssetDefine.PLAYER_AI_LUA_NAME, CAssetDefine.PLAYER_AI_LUA_PATH);
        }
