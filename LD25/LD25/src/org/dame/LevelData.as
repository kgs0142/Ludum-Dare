package org.dame 
{
    //FIXME add ai class here
    import com.ai.CDeadGuy;
    import com.ai.CDiary;
    import com.ai.CEnemy;
    import com.ai.CFishPic;
    import com.ai.CHangerBig;
    import com.ai.CHangerSmall;
	...
	public class LevelData extends BaseLevel
	{
        ...
        // the enemies group
        public var otherOverlapGroup:LayerData = null;
		...
		{
            //FIXME add all the sprite class here
            CTv;
            CDoor;
            CFishPic;
            CHangerBig;
		...
		private function xmlLoaded(filename:String, xml:XML, callbackData:Object ):void
		{
			...
			for each( var layerXML:XML in xml.layer )
			{
                ...
                else if (layer.name == "others")
                {
                    otherOverlapGroup = layer;
                }
				...
				for each( var spriteXML:XML in layerXML.sprite )
				{
                    ...
                    SpriteClass = this.GetSpriteClassFromName(spriteXML.attribute("class"));
		...
		override public function addSpriteToLayer(obj:FlxSprite, type:Class, layer:FlxGroup, xpos:Number, ypos:Number, angle:Number, scrollX:Number, scrollY:Number, flipped:Boolean = false, scaleX:Number = 1, scaleY:Number = 1, properties:Array = null, onAddCallback:Function = null):FlxSprite
		{
            ...
            if (spr is CEnemy || spr is CIAObject)
            {
                otherOverlapGroup.add(spr);
            }
